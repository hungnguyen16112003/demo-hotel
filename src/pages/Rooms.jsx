...
const Rooms = () => {
  return (
    <section className="bg-slate-50 py-16 min-h-screen motion-safe:animate-fade-up">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 max-w-2xl mx-auto motion-safe:animate-fade-in">
